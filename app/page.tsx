...
// Mock card — shows the "dark-luxury" template output, floats in hero
function MockCard() {
  return (
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{ background: 'linear-gradient(to top, rgba(14,14,20,0.95), transparent)' }}
          />
        ...
        <div className="p-5 space-y-4">
          <h3 className="font-display font-bold text-[15px] leading-snug" style={{ color: G.text }}>
            דירת 4 חדרים עם נוף לים
          </h3>
          <p className="font-display font-bold text-[28px] leading-none" style={{ color: G.gold }}>
            ₪2,500,000
          </p>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div
              className="text-center text-[11px] font-semibold py-2.5 rounded-xl"
              style={{ color: 'rgba(255,255,255,0.6)', border: '1px solid rgba(255,255,255,0.09)' }}
            >
              📞 התקשר
            </div>
            <div
              className="text-center text-[11px] font-semibold py-2.5 rounded-xl text-white"
  ...
  return (
    <div dir="rtl" lang="he" className="font-body" style={{ background: G.bg, color: G.text, minHeight: '100vh' }}>
      ...
      >
        <div className="flex items-center gap-2.5">
          <div
            ...
            style={{ background: `linear-gradient(135deg, ${G.blue}, #1d4ed8)` }}
          >
            P
          </div>
          <span className="font-display font-bold text-base tracking-tight" style={{ color: G.text }}>
            Property Builder
          </span>
        </div>
        <div className="flex items-center gap-3">
          <Link href="/examples" className="text-sm font-medium hidden sm:block transition-colors" style={{ color: G.muted }}>
            דוגמאות
          </Link>
          <FeedbackWidget direction="down" />
          <ThemeToggle />
          <Link
            href="/builder"
            className="text-sm font-bold px-5 py-2.5 rounded-xl text-white transition-all"
            style={{
              background: `linear-gradient(135deg, var(--pb-accent), #1d4ed8)`,
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20 w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 lg:max-w-[560px]">
            <div
              className="pb-s1 inline-flex items-center gap-2 mb-8 px-4 py-2 rounded-full text-xs font-medium"
              style={{ background: 'rgba(255,255,255,0.05)', border: `1px solid ${G.border}`, color: G.muted }}
            >
              <span
            ...
            <h1
              className="pb-s2 font-display font-black leading-[1.05] mb-6"
              style={{ fontSize: 'clamp(2.8rem, 5.5vw, 4.4rem)', color: G.text }}
            >
              הנכס שלכם
              <br />
            ...
            <p
              className="pb-s3 text-lg leading-relaxed mb-8"
              style={{ color: G.muted, maxWidth: '460px' }}
            >
            ...
            <div className="pb-s4 flex flex-col sm:flex-row gap-3 mb-6">
              <Link
                ...
                style={{
                  background: `linear-gradient(135deg, ${G.blue}, #1d4ed8)`,
            ...
            <p className="pb-s5 text-sm" style={{ color: G.muted }}>
              ללא הרשמה · בעברית מלאה · מוכן לשיתוף בווטסאפ
            </p>

            {/* Returning user — open a saved property by its code */}
            <div className="pb-s5 mt-6 pt-5" style={{ borderTop: `1px solid ${G.border}` }}>
              <p className="text-xs mb-2" style={{ color: G.muted }}>כבר יצרתם דף? הזינו את הקוד שקיבלתם:</p>
              <CodeEntry />
            </div>
          </div>

          {/* ── Mock card (left in RTL) ── */}
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          ...
          >
            ...
            <Link
              ...
              style={{ background: 'rgba(37,99,235,0.85)', color: '#ffffff', border: '1px solid rgba(37,99,235,0.9)' }}
            >
              צרו דף למכירה ←
            </Link>
          </div>
          ...
          <div
            className="rounded-3xl p-8 flex flex-col"
            style={{
              background: 'linear-gradient(145deg, rgba(34,197,94,0.09) 0%, rgba(34,197,94,0.02) 100%)',
          ...
          >
            ...
            <Link
              ...
              className="self-start px-5 py-2.5 rounded-xl text-sm font-bold transition-all"
              style={{ background: 'rgba(22,163,74,0.85)', color: '#ffffff', border: '1px solid rgba(22,163,74,0.9)' }}
            >
              צרו דף להשכרה ←
            </Link>
          </div>
      ...
      <section
        ...
        style={{ background: G.surface, borderTop: `1px solid ${G.border}`, borderBottom: `1px solid ${G.border}` }}
      >
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: G.muted }}>התהליך</p>
            <h2 className="font-display font-black text-3xl sm:text-4xl" style={{ color: G.text }}>
              ארבעה שלבים
            </h2>
          </div>
          {/* Grid separated by 1px borders */}
            ...
            {STEPS.map((s, i) => (
              <div
                ...
                style={{
                  ...
                  borderRight: i < 3 ? `1px solid ${G.border}` : undefined,
                }}
              >
                <p
                  className="font-display font-black text-5xl mb-5 leading-none"
                  style={{ color: i === 0 ? G.gold : 'var(--pb-border)' }}
                >
                  {s.n}
                </p>
      ...
      <section className="max-w-5xl mx-auto px-6 py-24">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {FEATURES.map((f) => (
            <div
              key={f.title}
              className="p-6 rounded-2xl flex flex-col gap-3 transition-all duration-200 hover:-translate-y-1"
      ...
      <section
        ...
        style={{ background: G.bg, borderTop: `1px solid ${G.border}` }}
      >
        <div
          className="absolute inset-0 pointer-events-none"
          style={{ background: 'radial-gradient(ellipse at 50% 50%, rgba(212,168,83,0.07) 0%, transparent 60%)' }}
        />
        <div className="relative">
          <p className="text-xs font-bold tracking-widest uppercase mb-4" style={{ color: G.muted }}>מוכנים?</p>
          <h2
            className="font-display font-black mb-4"
            style={{ fontSize: 'clamp(2.2rem, 5vw, 3.5rem)', color: G.gold }}
          >
            צרו דף שמוכר
          </h2>
      ...
      <footer
        ...
        style={{ borderTop: `1px solid ${G.border}`, color: G.muted }}
      >
        <p>
